...
awards:
  - title: Python Data Structures
    url: https://www.coursera.org/account/accomplishments/certificate/BPMHK5HWDH42
    date: '2022-03-10'
    awarder: Coursera
    icon: coursera
    summary: |
      During the course, I delved beyond the fundamentals of procedural programming and used Python's data structures—such as lists, dictionaries, and tuples—for more intricate data analysis tasks. 🚀🐍


  - title: Programming for Everybody (Getting Started with Python)
    url: https://www.coursera.org/account/accomplishments/certificate/347J7B7HXLL6
    date: '2022-01-30'
    awarder: Coursera
    icon: Coursera
    summary: |
